function [error] = calibrateMe90(params)


parameters.nr = 14; % recovery time in days
parameters.lambda23 =1/500; % death rate

parameters.r =0.1; % share reported sick in the long run

parameters.eta = 0.9;% 0.5; % share of healthy that are infectuous
parameters.rhoBar = 273; % share of infected in the long run
...
opts = odeset('RelTol',1e-5,'AbsTol',1e-7,'Refine',1,'NonNegative',[1 1 1]); %% options for the ode solver
