function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters90()
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe90,params0,A,b,Aeq,beq,lb,ub,[],options);
