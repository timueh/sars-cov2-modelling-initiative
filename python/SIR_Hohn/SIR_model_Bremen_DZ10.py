...
delta= 0.00021 # death rate of infected individuals # based on GERMAN data
...
#plt.plot(time,(I+R)*0.1,'r',label='10% infected cumulative')
...
#plt.plot(time,R*0.1,'g',label='10% recovered')
...
plt.title('Covid Model for Bremen plus surrounding (assuming 90\% unreported cases)')
plt.legend(loc=5)
...
print np.max(I)*0.013
print np.max(I)*0.002
