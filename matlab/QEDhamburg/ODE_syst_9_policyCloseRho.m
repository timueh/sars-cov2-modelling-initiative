function dp = ODE_syst_9_policyCloseRho(t,p,parameters)
...
% parameters
    ...
    rhoBar = parameters.rhoBar*0.5; % share of infected in the long run
    ...
    a = parameters.a*0.5; % TAKE HALF VALUE WHEN SHUT DOWN
