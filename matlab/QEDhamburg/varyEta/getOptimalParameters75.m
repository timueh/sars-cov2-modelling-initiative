function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters75()
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe75,params0,A,b,Aeq,beq,lb,ub,[],options);
