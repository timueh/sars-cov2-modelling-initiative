function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters40()
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe40,params0,A,b,Aeq,beq,lb,ub,[],options);
