function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters250()
...
% initial guess for a
a = 0.0002; %1/83100^(beta_p-alpha_p)/83100;
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe250,params0,A,b,Aeq,beq,lb,ub,[],options);
