function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters750()
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe750,params0,A,b,Aeq,beq,lb,ub,[],options);
