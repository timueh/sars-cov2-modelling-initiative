function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters500()
...
% initial guess for a
a =  0.001966732434347;%1/83100^(beta_p-alpha_p)/83100;
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe500,params0,A,b,Aeq,beq,lb,ub,[],options);
