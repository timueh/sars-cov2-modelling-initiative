function [etaOptimal, alphaOptimal, betaOptimal, gammaOptimal,lambda23Optimal,rOptimal,rhoBarOptimal,aOptimal] = getOptimalParameters100()
...
% initial guess for a
a = 0.0002; %0.005; %1/83100^(beta_p-alpha_p)/83100;
...
format long
[params,fval,exitflag] = fmincon(@calibrateMe100,params0,A,b,Aeq,beq,lb,ub,[],options);
